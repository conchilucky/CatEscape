...
public class ADSample : MonoBehaviour, IUnityAdsInitializationListener, IUnityAdsLoadListener, IUnityAdsShowListener
{
    ...
    public Text myText;
    public CharacterController3D characterScript;
    public bool heConseguidoLaRecompensa;

    public bool hasVistoElVideo;
    
    private void Awake()
    {
        myText.text = "Ver anuncio y continuar";
    ...
    private void Start()
    {
        heConseguidoLaRecompensa = false;
        hasVistoElVideo = false;
    }
    ...
    public void OnUnityAdsShowComplete(string placementId, UnityAdsShowCompletionState showCompletionState)
    {
        ...
        if (placementId.Equals("Rewarded_Android") && UnityAdsShowCompletionState.COMPLETED.Equals(showCompletionState))
        {
            ...
            heConseguidoLaRecompensa = true;
            characterScript.ReaparecerGameOver();
